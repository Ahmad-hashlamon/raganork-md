...
module.exports = {
    VERSION: 'v3.0.0',
    ALIVE: process.env.ALIVE || "https://telegra.ph/file/20b6bb95bb8fbfa9e1839.jpg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    BOT_INFO: process.env.BOT_INFO || 'Shadow;Skl11;0;https://telegra.ph/file/20b6bb95bb8fbfa9e1839.jpg;https://chat.whatsapp.com',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA||"سنقر لا تسرق",
    BOT_NAME: process.env.BOT_NAME || 'ٍShadow',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢٭𝑺𝜣𝑼𝑹𝛢𝑽𝑲𝑳¹¹ꫂ;Shadow MD bot;https://telegra.ph/file/20b6bb95bb8fbfa9e1839.jpg' : process.env.AUDIO_DATA,
